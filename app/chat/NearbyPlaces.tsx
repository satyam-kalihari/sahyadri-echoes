      ...
      <AnimatePresence>
        {error && !isOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 20 }}
            className="mt-3 px-4 py-2.5 bg-red-900/60 backdrop-blur-xl border border-red-500/30   text-red-200 text-xs max-w-sm"
          >
            {error}
          </motion.div>
        )}
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/10 bg-white/5">
              ...
              <div className="flex items-center gap-1">
                <button
                  onClick={toggleAudio}
                  className="p-1.5   hover:bg-white/10 text-slate-400 hover:text-teal-400 transition-colors"
                >
                  {isPlaying ? (
