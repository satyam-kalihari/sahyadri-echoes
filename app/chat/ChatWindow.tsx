...
import { Send, User, Bot, Loader2, Mic, Square, X } from "lucide-react";
...
export default function ChatWindow({
  ...
  const handleSend = async (audioBlob?: Blob) => {
    ...
    try {
      ...
      console.error(error);
      let errorMsg =
        "I apologize, the winds are strong and I cannot hear you clearly. Please try again.";
      if (language === "mr")
        errorMsg =
          "क्षमस्व, वारे खूप जोरात आहेत आणि मला तुमचे बोलणे स्पष्ट ऐकू येत नाही. कृपया पुन्हा प्रयत्न करा.";
      if (language === "hi")
        errorMsg =
          "क्षमा करें, हवाएं बहुत तेज हैं और मैं आपको स्पष्ट रूप से नहीं सुन पा रहा हूँ। कृपया पुनः प्रयास करें।";
      if (language === "gu")
        errorMsg =
          "માફ કરશો, પવનો ખૂબ જોરદાર છે અને હું તમને સ્પષ્ટ રીતે સાંભળી શકતો નથી. કૃપા કરીને ફરી પ્રયાસ કરો.";
      setMessages((prev) => [
        ...prev,
    ...
    <div className="w-full max-w-md h-[500px] flex flex-col bg-black/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
      ...
      <div className="p-4 border-b border-white/10 bg-white/5 flex items-start justify-between">
        <div>
          ...
          <span className="text-xs text-teal-400 font-mono uppercase">
        ...
        {onClose && (
          <button
            onClick={onClose}
            className="p-1.5   hover:bg-white/10 text-slate-400 hover:text-white transition-colors"
      ...
      <div className="p-4 border-t border-white/10 bg-black/40">
        <div className="flex items-center gap-2 bg-white/5   px-2 py-2 border border-white/10 focus-within:border-teal-500/50 transition-colors">
          <input
            type="text"
            value={input}
            ...
            placeholder={
              isRecording
                ...
                : language === "en"
                  ...
                  : language === "mr"
                    ? "या ठिकाणाबद्दल विचारा..."
                    : language === "hi"
                      ? "इस जगह के बारे में पूछें..."
                      : "આ જગ્યા વિશે પૂછો..."
            }
          ...
          <button
            ...
            className="p-2   hover:bg-white/10 text-teal-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
